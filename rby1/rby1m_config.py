...
rby1m_config = {
    "video": ModalityConfig(
        delta_indices=[0],
        modality_keys=["cam_front_head", "cam_right_wrist", "cam_left_wrist"], # Must match a key in meta/modality.json under "video"
    ),
    ...
    "action": ModalityConfig(
        delta_indices=list(range(0, _ACTION_HORIZON)), # Action prediction horizon (Action Chunk Size)
        modality_keys=[
